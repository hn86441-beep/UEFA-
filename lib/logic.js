...
const SAVE_TEMPLATES = [
  "🧤 يا له من تصدٍّ عظيم!! {player} ينقذ {team} من هدف محقق في الدقيقة {minute}!",
  "🧤 تصدٍّ أسطوري من {player}! {team} تتنفس الصعداء في الدقيقة {minute}!",
  "🧤 قفزة رائعة من {player}! كرة كانت في الشباك لولا يقظته في الدقيقة {minute}!",
  "🧤 حارس {team} {player} يقول لا في الدقيقة {minute}!",
];
...
export function generateCommentaryLine(event) {
  const templates = TEMPLATES_BY_TYPE[event.type] || GOAL_TEMPLATES;

...
export async function getData() {
  if (hasKV) {
    ...
    // مهم جدًا: لا نكتب أي شيء إلى قاعدة البيانات هنا أبدًا. لو رجعت القراءة فارغة
    // لأي سبب عابر (تأخير شبكة، تهيئة أولى...)، نعيد بيانات افتراضية للعرض فقط في
    // الذاكرة، دون حفظها — بهذا لا يمكن لأي قراءة فاشلة أن تمحو بيانات حقيقية موجودة.
